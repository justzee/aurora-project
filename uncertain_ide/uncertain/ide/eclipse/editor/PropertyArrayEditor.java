...
//	    mPropertyViewer = new TableViewer(parent,SWT.BORDER|SWT.FULL_SELECTION);
	    ...
	    mPropertyViewer.setCellModifier( new PropertyArrayCellModifier(mPropertyViewer,mDirtyObject));
	...
	public void fillActionToolBars(ToolBarManager actionBarManager) {
		// 生成按钮，按钮就是一个个的Action
		Element element = Activator.getSchemaManager().getElement(mData);
		...
		if (element.isArray()) {
			...
			Action addAction = new AddElementAction(this,mData,qName,AddPropertyAction.getDefaultImageDescriptor(),null);
	
			Action removeAction = new RemoveElementAction(this,RemovePropertyAction.getDefaultImageDescriptor(),null);
			Action refreshAction = new RefreshAction(this,RefreshAction.getDefaultImageDescriptor(),null);
			/*
...
//		System.out.println("array mPropertyViewer refresh..");
		if(dirty){
