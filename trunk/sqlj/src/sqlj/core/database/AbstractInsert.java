...
import sqlj.core.DataTransfer;
import sqlj.core.IContext;
import sqlj.service.SqljService;
...
public abstract class AbstractInsert {
	...
	public AbstractInsert(IContext context, Object bean) {
		super();
		this.context = context;
		this.recordBean = bean;
	}

	public AbstractInsert(IContext context, Map map, String tableName,
			String pkName) {
		super();
		this.context = context;
		this.recordMap = map;
...
//						+ " is null.");
	...
	protected Map<String, InsertField> getInsertFieldOptions() throws Exception {
		...
		if (standardWhoEnabled) {
			SqljService sqlsvc = (SqljService) context;
			Long user_id = sqlsvc.getSessionLong("user_id");
