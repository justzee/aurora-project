...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link aurora.javascript.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected aurora.javascript.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return aurora.javascript.xml.XMLLib.Factory.create(
                "aurora.javascript.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return aurora.javascript.xml.XMLLib.Factory.create(
                "aurora.javascript.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
