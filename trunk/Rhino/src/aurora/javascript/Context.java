...
import aurora.javascript.debug.DebuggableScript;
import aurora.javascript.debug.Debugger;
import aurora.javascript.xml.XMLLib;
...
public class Context
{
    ...
    /**
     * @deprecated
     * @see ContextFactory#removeListener(aurora.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
     ...
     *
     * @see aurora.javascript.ErrorReporter
     */
     ...
     * @see aurora.javascript.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (aurora.javascript.NativeContinuation) continuation,
                this, scope, args);
    }
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "aurora.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "aurora.javascript.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "aurora.javascript.regexp.RegExpImpl");
            if (cl != null) {
