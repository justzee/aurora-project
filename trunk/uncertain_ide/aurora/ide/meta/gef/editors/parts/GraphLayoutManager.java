...
class GraphLayoutManager extends AbstractLayout {
	...
	GraphLayoutManager(ViewDiagramPart diagram) {
...
//		graph.setDirection(PositionConstants.EAST);
		...
		CompoundDirectedGraphLayout compoundDirectedGraphLayout = new CompoundDirectedGraphLayout();
//		CompoundVerticalPlacement vl = new CompoundVerticalPlacement();
		compoundDirectedGraphLayout.visit(graph);
