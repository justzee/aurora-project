...
public class TextPage extends FormPage implements IViewer {
	...
	private UncertainStyledText mInnerText;
	...
	private void createStyledText(Composite parent) {
		mInnerText = new UncertainStyledText(parent, SWT.MULTI | SWT.V_SCROLL
				| SWT.H_SCROLL);
		mInnerText.addLineStyleListener(lineStyler);
		mInnerText.setLineSpacing(2);
		mInnerText.setFont(new Font(parent.getDisplay(), "Courier New", 10,
				SWT.NORMAL));
