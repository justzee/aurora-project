...
public class ActionsFactory {
	...
	public ActionListener[] createActions(ActionProperties actionProperties) throws ApplicationException {
		...
		List childElements = CompositeMapUtil
				.getAvailableChildElements(parent);
		...
		if (childElements != null) {
			...
			for (int i = 0; ite.hasNext(); i++) {
				...
				childActionListeners[i] = new AddElementAction(actionProperties
						.getViewer(), parent, qName,
	...
	private ActionListener[] getWizardActions(
			ActionProperties actionProperties, Element element) throws ApplicationException {
	...
	public void addActionsToMenu(Menu menu, ActionProperties actionProperties) throws ApplicationException{
	...
	public void addActionsToMenuManager(MenuManager menuManager,
			ActionProperties actionProperties) throws ApplicationException {
		ActionListener[] actionListeners = createActions(actionProperties);
