...
import node.action.RefreshAction;
import node.action.RemoveElementAction;
...
import celleditor.CellEditorFactory;
import celleditor.ICellEditor;
import editor.AbstractCMViewer;
import editor.core.ITableViewer;
import editor.core.IViewer;
import editor.widgets.core.ICellModifierListener;
import editor.widgets.core.IGridLabelProvider;
	...
	protected void createDefaultActions() {
		...
		if ((gridStyle & IGridViewer.isMulti) != 0) {
			...
			Action unAllCheckAction = new Action(LocaleMessage
					.getString("non.checed"), AuroraPlugin
					.getImageDescriptor(LocaleMessage
