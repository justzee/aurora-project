...
import node.action.AddPropertyAction;
import node.action.CategroyAction;
import node.action.CharSortAction;
import node.action.RefreshAction;
import node.action.RemovePropertyAction;
...
import editor.core.ICategoryTableViewer;
