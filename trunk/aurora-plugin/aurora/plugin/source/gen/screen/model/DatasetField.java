...
public class DatasetField extends AuroraComponent {
	...
	//
	// public static final String[] lov_keys = { READONLY, REQUIRED,
	// LOV_SERVICE,
	// TITLE, LOV_HEIGHT, LOV_GRID_HEIGHT, LOV_WIDTH };

	// public static final IPropertyDescriptor PD_READONLY = new
	// BooleanPropertyDescriptor(
	// READONLY, "*" + READONLY);
	// public static final IPropertyDescriptor PD_REQUIRED = new
	// BooleanPropertyDescriptor(
	// REQUIRED, "*" + REQUIRED);
	// public static final IPropertyDescriptor PD_DEFAULT_VALUE = new
	...
	public Object getPropertyValue(String propName) {
		...
		if (propertyValue == null && "inner_lov_service".equals(propName)) {
