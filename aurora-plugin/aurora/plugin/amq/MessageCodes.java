...
public final class MessageCodes {
	...
	public static final String INSTANCE_NOT_FOUND_ERROR ="aurora.plugin.amq.instance_not_found_error";
	public static final String IO_ERROR ="aurora.plugin.amq.io_errorr";
