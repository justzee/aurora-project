	...
	public void start() {
		...
		try {
			...
			if (!isRunning()) {
				...
				dbTool.updateIDocServerStatus(idocServerId, "Error occurred:please check the console or log for details.");
			} else {
			...
			System.err.println("Error! Connect IDocServer " + serverName + " failed!");
