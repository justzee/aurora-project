...
import aurora.javascript.v8dtoa.FastDtoa;
import aurora.javascript.xml.XMLLib;
import aurora.javascript.xml.XMLObject;
...
public class ScriptRuntime {
    ...
    public final static Class<?>
        ContextClass
            = Kit.classOrNull("aurora.javascript.Context"),
        ContextFactoryClass
            = Kit.classOrNull("aurora.javascript.ContextFactory"),
        FunctionClass
            = Kit.classOrNull("aurora.javascript.Function"),
        ScriptableObjectClass
            = Kit.classOrNull("aurora.javascript.ScriptableObject");
                                                       ...
                                                       boolean sealed)
    {
        ...
        new LazilyLoadedCtor(scope, "RegExp",
                "aurora.javascript.regexp.NativeRegExp", sealed, true);
        new LazilyLoadedCtor(scope, "Packages",
                "aurora.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(scope, "getClass",
                "aurora.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(scope, "JavaAdapter",
                "aurora.javascript.JavaAdapter", sealed, true);
        new LazilyLoadedCtor(scope, "JavaImporter",
                "aurora.javascript.ImporterTopLevel", sealed, true);
        new LazilyLoadedCtor(scope, "Continuation",
                "aurora.javascript.NativeContinuation", sealed, true);
    ...
    public static ScriptableObject getGlobal(Context cx) {
        final String GLOBAL_CLASS = "aurora.javascript.tools.shell.Global";
    ...
    private static class DefaultMessageProvider implements MessageProvider {
        public String getMessage(String messageId, Object[] arguments) {
            final String defaultResource
                = "aurora.javascript.resources.Messages";
