...
import aurora.javascript.annotations.JSConstructor;
import aurora.javascript.annotations.JSFunction;
import aurora.javascript.annotations.JSGetter;
import aurora.javascript.annotations.JSSetter;
import aurora.javascript.annotations.JSStaticFunction;
import aurora.javascript.debug.DebuggableObject;
 ...
 *
 * @see aurora.javascript.Scriptable
 * @author Norris Boyd
 */
                                                  ...
                                                  ConstProperties
{
     ...
     *
     * @see aurora.javascript.ScriptableObject#getAttributes(String)
     * @see aurora.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see aurora.javascript.ScriptableObject
     ...
     *
     * @see aurora.javascript.ScriptableObject#getIds()
     * @see aurora.javascript.ScriptableObject#getAttributes(String)
     * @see aurora.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see aurora.javascript.ScriptableObject#delete(String)
     * @see aurora.javascript.ScriptableObject#getAttributes(String)
     * @see aurora.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     * @see aurora.javascript.ScriptableObject#has(String, Scriptable)
     * @see aurora.javascript.ScriptableObject#READONLY
     * @see aurora.javascript.ScriptableObject#DONTENUM
     * @see aurora.javascript.ScriptableObject#PERMANENT
     * @see aurora.javascript.ScriptableObject#EMPTY
     */
     ...
     * @exception EvaluatorException if the named property is not found
     * @see aurora.javascript.Scriptable#has(String, Scriptable)
     * @see aurora.javascript.ScriptableObject#READONLY
     * @see aurora.javascript.ScriptableObject#DONTENUM
     * @see aurora.javascript.ScriptableObject#PERMANENT
     * @see aurora.javascript.ScriptableObject#EMPTY
     ...
     * @see aurora.javascript.Function
     * @see aurora.javascript.FunctionObject
     * @see aurora.javascript.ScriptableObject#READONLY
     * @see aurora.javascript.ScriptableObject
     ...
     * @see aurora.javascript.Scriptable#put(String, Scriptable, Object)
     */
