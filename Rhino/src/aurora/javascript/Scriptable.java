...
public interface Scriptable {
     ...
     * <LI>aurora.javascript.Scriptable objects</LI>
     * <LI>null</LI>
     ...
     * @see aurora.javascript.Context#getUndefinedValue
     */
     ...
     * @see aurora.javascript.Scriptable#get(String, Scriptable)
     * @see aurora.javascript.ScriptableObject#getProperty(Scriptable, String)
     */
     ...
     * @see aurora.javascript.ScriptableObject#getProperty(Scriptable, int)
     */
     ...
     * @see aurora.javascript.Scriptable#get(String, Scriptable)
     * @see aurora.javascript.ScriptableObject#putProperty(Scriptable, String, Object)
     * @see aurora.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see aurora.javascript.Scriptable#get(int, Scriptable)
     * @see aurora.javascript.ScriptableObject#putProperty(Scriptable, int, Object)
     * @see aurora.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see aurora.javascript.Scriptable#get(String, Scriptable)
     * @see aurora.javascript.ScriptableObject#deleteProperty(Scriptable, String)
     */
     ...
     * @param index the numeric index for the property
     * @see aurora.javascript.Scriptable#get(int, Scriptable)
     * @see aurora.javascript.ScriptableObject#deleteProperty(Scriptable, int)
     */
