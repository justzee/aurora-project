...
import aurora.classfile.*;
import aurora.javascript.*;
import aurora.javascript.ast.FunctionNode;
import aurora.javascript.ast.Jump;
import aurora.javascript.ast.Name;
import aurora.javascript.ast.ScriptNode;

import java.util.*;
import java.lang.reflect.Constructor;

import static aurora.classfile.ClassFileWriter.ACC_FINAL;
import static aurora.classfile.ClassFileWriter.ACC_PRIVATE;
import static aurora.classfile.ClassFileWriter.ACC_PUBLIC;
import static aurora.classfile.ClassFileWriter.ACC_STATIC;
import static aurora.classfile.ClassFileWriter.ACC_VOLATILE;
...
public class Codegen implements Evaluator
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "aurora.javascript.gen." + baseName + "_" + serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("aurora/javascript/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "aurora/javascript/BaseFunction",
                      "createObject",
                      "(Laurora/javascript/Context;"
        ...
        cfw.add(ByteCode.INSTANCEOF, "aurora/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "aurora/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "aurora/javascript/ScriptRuntime",
                      "hasTopCall",
                      "(Laurora/javascript/Context;"
                      +")Z");
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Laurora/javascript/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "aurora/javascript/NativeFunction",
                      "initScriptFunction",
                      "(Laurora/javascript/Context;"
                      +"Laurora/javascript/Scriptable;"
                      +")V");
    ...
    private void emitRegExpInit(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Laurora/javascript/Context;"
                      +")Laurora/javascript/RegExpProxy;");
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "aurora/javascript/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "aurora/javascript/Undefined",
    ...
    String getBodyMethodSignature(ScriptNode n)
    {
        ...
        sb.append("Laurora/javascript/Context;"
                  +"Laurora/javascript/Scriptable;"
                  +"Laurora/javascript/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Laurora/javascript/Scriptable;"
          +"Laurora/javascript/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generateGenerator()
    {
        ...
        addScriptRuntimeInvoke("createFunctionActivation",
                               "(Laurora/javascript/NativeFunction;"
                               +"Laurora/javascript/Scriptable;"
                               +"[Ljava/lang/Object;"
                               +")Laurora/javascript/Scriptable;");
        cfw.addAStore(variableObjectLocal);
        ...
        addOptRuntimeInvoke("createNativeGenerator",
                               "(Laurora/javascript/NativeFunction;"
                               +"Laurora/javascript/Scriptable;"
                               +"Laurora/javascript/Scriptable;II"
                               +")Laurora/javascript/Scriptable;");
    ...
    private void generateThrowJavaScriptException()
    {
        cfw.add(ByteCode.NEW,
                        "aurora/javascript/JavaScriptException");
    ...
    private void generateArrayLiteralFactory(Node node, int count) {
        ...
        argsLocal = firstFreeLocal++;
        localsMax = firstFreeLocal;
        cfw.startMethod(methodName, "(Laurora/javascript/Context;"
                +"Laurora/javascript/Scriptable;"
                +"Laurora/javascript/Scriptable;"
                +"[Ljava/lang/Object;"
                +")Laurora/javascript/Scriptable;",
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Laurora/javascript/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Laurora/javascript/Scriptable;"
                            +"Laurora/javascript/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Laurora/javascript/Callable;"
                            +"Laurora/javascript/Scriptable;"
                            +"Laurora/javascript/Context;"
                            +"Laurora/javascript/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
    ...
    private String exceptionTypeToName(int exceptionType)
    {
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            return "aurora/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            return "aurora/javascript/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            return "aurora/javascript/EcmaError";
