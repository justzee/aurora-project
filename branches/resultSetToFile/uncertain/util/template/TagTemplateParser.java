...
public class TagTemplateParser {
    ...
    private static class ParseHandle implements TagParseHandle {
        ...
        public String  ProcessTag(int index, String tag){
            ...
            if(creator!=null){
                ...
                if(tc==null) tc = new ErrorTag(mSourceName,0,0,"Unknown tag:"+tag);
            }else
        ...
        public int ProcessCharacter( int index, char ch){
            if( mBuf == null) mBuf = new StringBuffer();
            mBuf.append(ch);
            return -1; 
        }
    ...
    public TextTemplate buildTemplate( String source_name, InputStream is, ITagCreatorRegistry reg )
        throws IOException
    {
    ...
    public TextTemplate buildTemplate( Reader reader, ITagCreatorRegistry registry )
        throws IOException
    {
        return buildTemplate( null, reader, registry );
    }
    
    public TextTemplate buildTemplate( File template_file, ITagCreatorRegistry registry)
        throws IOException
    {
