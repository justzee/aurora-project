/*
 * Created on 2011-7-13 上午12:12:02
 * $Id$
 */
...
public class ResultSetWithStatement implements ResultSet {
    
    ResultSet   realResultSet;
    Statement   attachedStatement;
    
    /**
     * @param realResultSet
     * @param attachedStatement
     */
    public ResultSetWithStatement(ResultSet realResultSet,
            Statement attachedStatement) {
        super();
        this.realResultSet = realResultSet;
        this.attachedStatement = attachedStatement;
    }
    
    // The only method overrided
    public void close() throws SQLException {
        SQLException sex = null;
        try{
            attachedStatement.close();
    ...
    // ========== Below are all delegated methods =================
    ...
    public Object getObject(int arg0, Map arg1) throws SQLException {
        return realResultSet.getObject(arg0, arg1);
    }
