...
public class BuiltinExceptionFactory {
    ...
    public static GeneralException createClassNotFoundException( ILocatable locatable, String className){
        return new GeneralException("uncertain.exception.class_not_found", new Object[]{className}, (Throwable)null, locatable );
    }
}
