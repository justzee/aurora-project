...
//implements IMappingHandle
{
    ...
    public final class ConfigurationLoader implements IterationHandle {
        ...
        /**
         * @param ignoredQnameSet
         */
        public ConfigurationLoader(Set ignoredQnameSet) {
            mIgnoredQnameSet = ignoredQnameSet;
        }

        Set     mIgnoredQnameSet;
        
        public int process( CompositeMap map){
            if(mIgnoredQnameSet!=null)
                if(mIgnoredQnameSet.contains(map.getQName()))
    ...
    public void loadConfig(CompositeMap config){
        ...
        IterationHandle handle = new ConfigurationLoader();
