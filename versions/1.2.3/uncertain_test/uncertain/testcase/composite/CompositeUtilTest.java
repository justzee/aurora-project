...
public class CompositeUtilTest extends TestCase {
    ...
    static final String PKG_NAME = CompositeUtilTest.class.getPackage()
            .getName();
    // static final QualifiedName FIELD = new QualifiedName(null,"field");
    ...
    public void testMergeChildsByOverride() throws Exception {
        CompositeMap parent = loader
                .loadFromClassPath(PKG_NAME + ".parent_map");
        CompositeMap child = loader.loadFromClassPath(PKG_NAME + ".child_map");
        CompositeUtil.mergeChildsByOverride(parent.getChild("fields"), child
                .getChild("fields"), "name");
    ...
    public void testMergeChildsByReference() throws Exception {
        CompositeMap parent = loader
                .loadFromClassPath(PKG_NAME + ".parent_map");
        CompositeMap child = loader.loadFromClassPath(PKG_NAME + ".child_map");
        CompositeUtil.mergeChildsByReference(parent.getChild("fields"), child
                .getChild("fields"), "name");
